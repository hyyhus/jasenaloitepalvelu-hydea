...
#      post :create, history: { basket_id: @history.basket_id, time: @history.time, user_id: @history.user_id }
#    end
#
...
#    patch :update, id: @history, history: { basket_id: @history.basket_id, time: @history.time, user_id: @history.user_id }
#    assert_redirected_to history_path(assigns(:history))
#  end
