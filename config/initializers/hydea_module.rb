module Hydea 
  ...
  module Haka
    ...
    SAML_ASSERTION_CONSUMER_SERVICE_URL = ENV.fetch("SAML_ASSERTION_CONSUMER_SERVICE_URL")
     ...
     HAKA_TESTSERVER_METADATA_URL         = ENV.fetch("HAKA_TESTSERVER_METADATA_URL")
     HAKA_TESTSERVER_SIGN_CERT            = ENV.fetch("HAKA_TESTSERVER_SIGN_CERT")
     HAKA_SERVER_SIGN_CERT                = ENV.fetch("HAKA_SERVER_SIGN_CERT")
