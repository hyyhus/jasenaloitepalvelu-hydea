  ...
  class AuthController < ApplicationController
    ...
    def new      
      begin
          ...
          Xmlsec::verify_file(haka_server_metadata, Hydea::Haka::HAKA_SERVER_SIGN_CERT)
        rescue
    ...
    begin
      ...
      def saml_settings
        ...
        settings.idp_cert                       = metadata.xpath("//entitydescriptor[@entityid='#{Hydea::Haka::SAML_IDP_ENTITY_ID}']//x509certificate")
        settings.name_identifier_format         = metadata.xpath("//entitydescriptor[@entityid='#{Hydea::Haka::SAML_IDP_ENTITY_ID}']//nameidformat").text
