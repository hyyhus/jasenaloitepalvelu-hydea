  ...
  class AuthController < ApplicationController
    ...
    begin
      ...
      def saml_settings
        ...
        settings.idp_cert                       = testservermetadata.xpath("//entitydescriptor[@entityid='#{Hydea::Haka::SAML_IDP_ENTITY_ID}']//x509certificate")
        settings.name_identifier_format         = testservermetadata.xpath("//entitydescriptor[@entityid='#{Hydea::Haka::SAML_IDP_ENTITY_ID}']//nameidformat").text
